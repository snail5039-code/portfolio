...
출퇴근 기록, AI 경로 안내, 워크스페이스 채팅과 알림, 관리자 근태 확인을 하나로 묶은 협업형 출퇴근 관리 서비스입니다.
...
- **Highlights**: ODsay·TMAP·OSRM 경로 탐색, 채팅 알림, 회원탈퇴, 다크 테마, PWA·Windows 앱
...
| 🌐 | [출퇴근 생존일지](./commute-battle) | 워크스페이스 채팅·알림과 AI 경로 안내를 결합한 출퇴근 관리 서비스 | Next.js 16, Supabase, Gemini, Electron | **배포** |
...
| **Data / Infra** | MySQL, PostgreSQL, Supabase, Firebase, Vercel |
