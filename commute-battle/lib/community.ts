...
export const DEFAULT_NOTICES: CommunityPost[] = [
  { id: 'notice-welcome', category: 'notice', title: '출퇴근 생존일지 커뮤니티에 오신 것을 환영합니다', content: '출퇴근 경험과 유용한 정보를 편안하게 나누는 공간입니다. 서로를 배려하는 표현으로 즐겁게 참여해 주세요.', author: '운영팀', createdAt: '2026-08-05T09:00:00+09:00' },
